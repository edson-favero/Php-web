...
<html lang="pt-br">
	<head>
		<meta charset="utf-8">
			...
			<title>Remover Engenheiro</title>
	</head>
...
<label for="engenheiroEscolhido" class="form-label">Escolha qual engenheiro você deseja remover do banco de dados: </label>
...
?>
	...
	<button type="submit" class="btn btn-primary">Remover engenheiro </button>
	</form>
...
<?php
	...
	{
		require_once "C:/xampp/htdocs/Php-web/php-web/php/model/engenheiro.php";
		excluirEngenheiro($_POST["engenheiroEscolhido"]);
		echo "Engenheiro excluído com sucesso do BD!";
	}
?>
